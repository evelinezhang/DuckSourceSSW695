...
<div class="art-content-layout layout-item-6">
    ...
    <form:form commandName="resubmit" method="post" enctype="multipart/form-data">
        <table class="art-article" style="width: 100%; ">
        	<tbody>
                ...
                <tr>
                   ...
                   <td style="width: 77%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
                   		<textarea name="comments" style="font-size: 14px;" rows="4" cols="50">${opportunitySubmitted.comment}</textarea>
                   </td>
                 </tr>
                 <tr>
