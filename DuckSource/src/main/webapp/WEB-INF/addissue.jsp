...
<div class="art-sheet clearfix">
    ...
    <div class="art-layout-cell layout-item-1" style="width: 8%" >
		...
		<tr style="border: none; border-width: 0px;">
         	...
         	<tr style="border: none;">
         		<td style="border: none; text-align: center; padding-top: 10px" colspan="3"> <input class="art-button" type="submit" value="Add Review Issue" /></td>
         	</tr>         
          </tbody>
   	</table>
	</form:form>                                                                              	
